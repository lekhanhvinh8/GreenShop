...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        totalPrice.setText("Tổng giá: " + Integer.toString(price) + "đ");
            ...
            public void onClick(View v) {
                ...
                if(productHelper.getProductOfCart(userName).size() == 0){
                    new AlertDialog.Builder(CartActivity.this)
                            ...
                            .setMessage("Giỏ hàng của bạn chưa có sản phẩm nào")
                ...
                new AlertDialog.Builder(CartActivity.this)
                        // Specifying a listener allows you to take an action before dismissing the dialog.
                        .setTitle("Đặt hàng")
                        .setMessage("Bạn muốn đặt hàng tất cả món hàng ở trên")
